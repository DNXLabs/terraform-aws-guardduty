...
def lambda_handler(event, context):
    ...
    sns_email_arn = os.environ["sns_email_arn"]
    ...
    if event_severity <= int(event_threshold):   
        ...
        response = client.publish(TargetArn=sns_email_arn, Message=json.dumps(event,indent=2), Subject="Guarduty Notifications")